...
- Mneme memory department (eviction-triggered summarization, persistent snapshots, associative recall)
...
- Semantic memory layers 2–3 (Mneme) — event pinning, semantic search
