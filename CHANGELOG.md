...
- **SQL schema format** — switched to `structure.sql` to support FTS5 virtual tables that can't be expressed in Ruby DSL; Rake task auto-strips internal FTS5 tables from dumps (#252)
